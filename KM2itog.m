...
IDOT = deg2rad(2.53544e-8); % Скорость угла наклона
...
t = 86400+18 + i; % Количество секунд от начала текущей недели при начале рассмотрения в 00:00:01
...
[x(i), y(i), z(i)] = ecef2enu(x_current(1,i),y_current(1,i),z_current(1,i),B,L,H,wgs84Ellipsoid,'radians'); % Отображение координат спутника относительно точки приема
