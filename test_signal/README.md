Контрольная 1: Модель сигнала ГНСС
==================================
...
Допустим, вы написали послание преподавателю в test_signals_report.doc. 
Положите его сюда. 
...
```sh
git add test_signals_report.doc test_signals_report.pdf 
```
